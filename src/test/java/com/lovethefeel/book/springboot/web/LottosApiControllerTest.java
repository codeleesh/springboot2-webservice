...
public class LottosApiControllerTest {
    ...
    public void Lottos_등록된다() throws Exception {
        //given
        int cnt = 5;
        LottosSaveRequestDto requestDto = LottosSaveRequestDto.builder()
                .cnt(cnt)
                .build();

        String url = "http://localhost:" + port + "/api/v1/lottos";
